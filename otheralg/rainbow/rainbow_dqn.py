...
class DQN(object):
    def __init__(self, args):
        self.action_dim = args.DQN_action_dim
        self.batch_size = args.DQN_batch_size  # batch size
        self.max_train_steps = args.DQN_max_train_steps
        self.lr = args.DQN_lr  # learning rate
        self.gamma = args.DQN_gamma  # discount factor
        self.tau = args.DQN_tau  # Soft update
        self.use_soft_update = args.DQN_use_soft_update
        self.target_update_freq = args.DQN_target_update_freq  # hard update
        self.update_count = 0

        self.grad_clip = args.DQN_grad_clip
        self.use_lr_decay = args.DQN_use_lr_decay
        self.use_double = args.DQN_use_double
        self.use_dueling = args.DQN_use_dueling
        self.use_per = args.DQN_use_per
        self.use_n_steps = args.DQN_use_n_steps
        if self.use_n_steps:
            self.gamma = self.gamma ** args.DQN_n_steps
