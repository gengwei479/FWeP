...
class ReplayBuffer(object):
    def __init__(self, args):
        ...
        self.buffer_capacity = args.DQN_buffer_capacity
        self.current_size = 0
        self.count = 0
        self.buffer = {'state': np.zeros((self.buffer_capacity, args.DQN_state_dim)),
                       'action': np.zeros((self.buffer_capacity, 1)),
                       'reward': np.zeros(self.buffer_capacity),
                       'next_state': np.zeros((self.buffer_capacity, args.DQN_state_dim)),
...
class Prioritized_ReplayBuffer(object):
    def __init__(self, args):
        ...
        self.alpha = args.DQN_alpha
        self.beta_init = args.DQN_beta_init
        self.beta = args.DQN_beta_init
        self.batch_size = args.DQN_batch_size
        self.buffer_capacity = args.DQN_buffer_capacity
