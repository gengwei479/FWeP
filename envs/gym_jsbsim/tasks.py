...
from . import assessors, rewards, utils
from .simulation import Simulation
from .properties import BoundedProperty, Property
from .aircraft import Aircraft
from .rewards import RewardStub
...
class BattleTask(Task):
    ...
    """
    episode_time_s = 60
    # 状态输入：经度，维度，高度，俯仰角，滚转角，偏航角，X轴速度,Y轴速度,Z轴速度，俯仰速度，滚转速度，偏转速度，
    base_state_variables = (prp.lat_geod_deg, prp.lng_geoc_deg, prp.altitude_sl_ft,
                            prp.pitch_rad, prp.roll_rad, prp.heading_deg, prp.u_fps,
                            prp.v_north_fps, prp.v_east_fps, prp.v_down_fps, prp.v_fps,
                            prp.w_fps, prp.p_radps, prp.q_radps, prp.r_radps, prp.aileron_left,
                            prp.elevator, prp.rudder, prp.throttle)
    # 动作：aileron, elevator, rudder, throttle
    action_variables = (prp.aileron_cmd, prp.elevator_cmd, prp.rudder_cmd, prp.throttle_cmd)

    def __init__(self, step_frequency_hz, aircraft):
        """
        Constructor
        ...
        self.max_time_s = self.episode_time_s
        ...
        self.state_variables = self.base_state_variables
        self.base_initial_conditions = {}
        self.legal_attribute_names = [prop.get_legal_name() for prop in
                                 self.state_variables]
        self.State = namedtuple('State', self.legal_attribute_names)

    def _get_initial_conditions(self, initial_condition):
        """
        ...
        """
        self.base_initial_conditions = {
            prp.initial_altitude_ft: initial_condition['position_h_sl_ft'],
            prp.initial_longitude_geoc_deg: initial_condition['position_long_gc_deg'],
            prp.initial_latitude_geod_deg: initial_condition['position_lat_geod_deg'],
            prp.initial_heading_deg: initial_condition['initial_heading_degree'],
            prp.initial_u_fps: initial_condition['velocities_v_north_fps'],
            prp.initial_v_fps: initial_condition['velocities_v_east_fps'],
            prp.initial_w_fps: initial_condition['velocities_v_down_fps'],
            prp.initial_p_radps: initial_condition['velocities_p_rad_sec'],
            prp.initial_q_radps: initial_condition['velocities_q_rad_sec'],
            prp.initial_r_radps: initial_condition['velocities_r_rad_sec'],
         }
        extra_conditions = {
                            # prp.initial_v_fps: 0,
                            # prp.initial_w_fps: 0,
    ...
    def task_step(self, sim: Simulation, action: Sequence[float], sim_steps: int) -> Tuple[np.ndarray, float, bool, Dict]:
...
class BattleTask_v2(Task):
    ...
    base_state_variables = (prp.lat_geod_deg, prp.lng_geoc_deg, prp.altitude_sl_ft,
                            ...
                            prp.v_north_fps, prp.v_east_fps, prp.v_down_fps, prp.v_fps,
                            prp.w_fps, prp.p_radps, prp.q_radps, prp.r_radps, prp.aileron_left,
                            prp.elevator, prp.throttle)
    # 动作：aileron, elevator, rudder, throttle
    action_variables = (prp.aileron_cmd, prp.elevator_cmd, prp.throttle_cmd)
    ...
    def _get_initial_conditions(self, initial_condition):
        ...
        self.base_initial_conditions = {
            ...
            prp.initial_latitude_geod_deg: initial_condition['position_lat_geod_deg'],
            prp.initial_heading_deg: initial_condition['initial_heading_degree'],
            prp.initial_u_fps: initial_condition['velocities_v_east_fps'],
            prp.initial_v_fps: initial_condition['velocities_v_north_fps'],
            prp.initial_w_fps: initial_condition['velocities_v_down_fps'],
            prp.initial_p_radps: initial_condition['velocities_p_rad_sec'],
            prp.initial_q_radps: initial_condition['velocities_q_rad_sec'],
            prp.initial_r_radps: initial_condition['velocities_r_rad_sec'],
